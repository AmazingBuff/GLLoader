...
INT WINAPI wglGetGPUInfoAMD (UINT id, INT property, unsigned int dataType, UINT size, void *data);
...
VOID WINAPI wglBlitContextFramebufferAMD (HGLRC dstCtx, int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, GLbitfield mask, unsigned int filter);
#endif
...
typedef unsigned char (WINAPI * PFNWGLCREATEDISPLAYCOLORTABLEEXTPROC) (unsigned short id);
typedef unsigned char (WINAPI * PFNWGLLOADDISPLAYCOLORTABLEEXTPROC) (const unsigned short *table, unsigned int length);
typedef unsigned char (WINAPI * PFNWGLBINDDISPLAYCOLORTABLEEXTPROC) (unsigned short id);
typedef VOID (WINAPI * PFNWGLDESTROYDISPLAYCOLORTABLEEXTPROC) (unsigned short id);
#ifdef WGL_WGLEXT_PROTOTYPES
unsigned char WINAPI wglCreateDisplayColorTableEXT (unsigned short id);
unsigned char WINAPI wglLoadDisplayColorTableEXT (const unsigned short *table, unsigned int length);
unsigned char WINAPI wglBindDisplayColorTableEXT (unsigned short id);
VOID WINAPI wglDestroyDisplayColorTableEXT (unsigned short id);
#endif
...
HANDLE WINAPI wglDXRegisterObjectNV (HANDLE hDevice, void *dxObject, unsigned int name, unsigned int type, unsigned int access);
BOOL WINAPI wglDXUnregisterObjectNV (HANDLE hDevice, HANDLE hObject);
BOOL WINAPI wglDXObjectAccessNV (HANDLE hObject, unsigned int access);
BOOL WINAPI wglDXLockObjectsNV (HANDLE hDevice, int count, HANDLE *hObjects);
BOOL WINAPI wglDXUnlockObjectsNV (HANDLE hDevice, int count, HANDLE *hObjects);
#endif
...
#ifdef WGL_WGLEXT_PROTOTYPES
BOOL WINAPI wglCopyImageSubDataNV (HGLRC hSrcRC, unsigned int srcName, unsigned int srcTarget, int srcLevel, int srcX, int srcY, int srcZ, HGLRC hDstRC, unsigned int dstName, unsigned int dstTarget, int dstLevel, int dstX, int dstY, int dstZ, int width, int height, int depth);
#endif
...
#ifdef WGL_WGLEXT_PROTOTYPES
BOOL WINAPI wglDelayBeforeSwapNV (HDC hDC, float seconds);
#endif
...
#ifdef WGL_WGLEXT_PROTOTYPES
BOOL WINAPI wglJoinSwapGroupNV (HDC hDC, unsigned int group);
BOOL WINAPI wglBindSwapBarrierNV (unsigned int group, unsigned int barrier);
BOOL WINAPI wglQuerySwapGroupNV (HDC hDC, unsigned int *group, unsigned int *barrier);
BOOL WINAPI wglQueryMaxSwapGroupsNV (HDC hDC, unsigned int *maxGroups, unsigned int *maxBarriers);
BOOL WINAPI wglQueryFrameCountNV (HDC hDC, unsigned int *count);
...
#ifdef WGL_WGLEXT_PROTOTYPES
void *WINAPI wglAllocateMemoryNV (int size, float readfreq, float writefreq, float priority);
